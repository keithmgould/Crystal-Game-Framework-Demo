// NOTE: this widget is breaking the sandbox rule by accessing Crystaljs directly,
// but its not part of the official game or framework, its just for debugging.
// So I'm OK with this for now.
define(['dat', 'backbone', 'crystaljs/transport', 'crystaljs/loop'], function (dat, Backbone, Transport, Loop) {
  var datgui;
